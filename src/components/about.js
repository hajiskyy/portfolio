    ...
    <section className="w-full" id="about">
      <div className="w-full py-32 flex flex-col md:flex-row justify-center md:justify-between items-center">
        ...
        <div className="mt-10 md:mt-0 md:w-1/2" ref={sectionTrigger}>
          ...
          <p className="font-secondary tracking-wider leading-normal my-5">Hey again, i'm a 22 year old developer. I like to bring bring ideas to life, from design to code. Besides that, you may find me watching anime with a pack of biscuits in my hands. </p>
